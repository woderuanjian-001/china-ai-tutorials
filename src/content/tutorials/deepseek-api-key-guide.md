---
title: "How to Get a DeepSeek API Key: Step-by-Step with Screenshots (2026)"
description: "Complete walkthrough to register DeepSeek, get your API key, top up credits, and make your first API call. Includes 4 payment solutions for users without a Chinese bank card."
category: "DeepSeek"
date: 2026-06-24
...
Open **[platform.deepseek.com](https://platform.deepseek.com)** in your browser.
...
|---------|---------|--------------|
| 登录 | Log In | Sign in to existing account |
| 注册 | Register | Create new account |
| 手机号 | Phone Number | Login with phone |
| 邮箱 | Email | Login with email |
| 验证码 | Verification Code | One-time code sent to phone/email |
...
2. Alternatively, go directly to: **[platform.deepseek.com/api_keys](https://platform.deepseek.com/api_keys)**
...
Click **「Billing」** or **「充值」** in the left sidebar, or go to **[platform.deepseek.com/billing](https://platform.deepseek.com/billing)**.

You'll see the top-up page with amounts in **Chinese Yuan (¥ / CNY)**:

| Top-Up Amount | USD Equivalent | Free Bonus | Total Credits |
|---------------|----------------|------------|---------------|
| ¥10 | ~$1.40 | ¥0 | ¥10 |
| ¥50 | ~$7.00 | ¥5 | ¥55 |
| ¥100 | ~$14.00 | ¥15 | ¥115 |
...
#### ✅ Method 2: WildCard Virtual Credit Card (Recommended)

**Works for**: EVERYONE — this is the most reliable method

[WildCard](https://wildcard.online) is a virtual Visa card service designed specifically for paying Chinese AI platforms. Here's the process:

1. Go to **[wildcard.online](https://wildcard.online)** and register (takes 2 minutes)
...
| Rotate keys every 90 days | Share keys in screenshots or chat |
| Set usage limits per key | Use one key for everything |
...
**Current supported regions**: Most countries worldwide except those under international sanctions. If you're unsure, check the [DeepSeek documentation](https://platform.deepseek.com/docs).
...
| Project | Difficulty | Time | Tutorial |
|---------|-----------|------|----------|
...
> 🔗 **Ready to start?** [Sign up for DeepSeek](https://platform.deepseek.com) and get 5 million free tokens. Need a payment solution? [WildCard virtual card](https://wildcard.online) works with all Chinese AI platforms.
>
> 📖 **Related Tutorials**:
> - [DeepSeek API Pricing Explained](/tutorials/deepseek-api-pricing-explained/) — how much you'll actually spend
> - [DeepSeek V4 vs GPT-5 Benchmark](/tutorials/deepseek-v4-vs-gpt5-benchmark/) — real performance data
> - [China AI Model Pricing Comparison 2026](/tutorials/china-ai-model-pricing-comparison/) — all 12 platforms compared
